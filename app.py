...
#2. AuthO Session Layer: 
#Auth0 also maintains a session for the user and stores their information inside a cookie.
#The next time a user is redirected to the Auth0 Lock screen,
#the user's information will be remembered. Log users out of Auth0 by clearing
#the Single Sign-on (SSO) cookie. do_logout()
##############################################################################
# General user routes:
